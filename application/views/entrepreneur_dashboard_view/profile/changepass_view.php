		...
		<div class="row">
			<div class="col-lg-12">
				<div class="changepass-profile">
					...
					<img src="../assets/photoofEntre/<?php echo $changepassdata->image ?>">
			...
			<div class="col-lg-12">
				...
				<div class="profile-form">
					<form action="<?php echo base_url('entrepreneur_dashboard_controller/change_password_entrepreneur/validate'); ?>" method="post" >
